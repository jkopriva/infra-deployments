...
function prepareWebhookVariables() {
    ...
    export webhook_repositoryURL=https://github.com/${REPO_OWNER-"redhat-appstudio"}/${REPO_NAME-"infra-deployments"}
    export webhook_repositoryFullName=${REPO_OWNER-"redhat-appstudio"}/${REPO_NAME-"infra-deployments"}
